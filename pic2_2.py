...
Example taken from: 
http://www.ieap.uni-kiel.de/et/people/wimmer/teaching/mhd/ex/ex3/pic_2.py
...
#        self.field[0:ng+1] -= sum/ng
        ...
        self.freq[0] = 0.01
        self.pot_ft[0:ng] = self.dens_ft[0:ng]/self.freq[0:ng]**2/4./pi**2/eps_0
        self.pot = ifft(self.pot_ft)
#        self.field[1:ng-2] = self.pot[2:ng-1] - self.pot[0:ng-3]
#        self.field[0] = self.pot[1] - self.pot[-1]
#        #self.field[-1] = self.pot[0] - self.pot[ng-2]
#        self.field[-1] = self.field[0]
#        self.field /= (-2.*step)
        self.field = -1.*gradient(self.pot)
        #print self.field
